...
const StandingsTable: React.FC<StandingsTableProps> = ({ standings, highlightClubId }) => {
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-sm text-left">
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                        {standings.map((team) => {
                            const isHighlighted = highlightClubId === team.club_id;
                            return (
                                <tr key={team.position} className={`${isHighlighted ? 'bg-emerald-50 dark:bg-emerald-900/30 border-l-4 border-l-emerald-500' : 'hover:bg-gray-50 dark:hover:bg-gray-700/50'} transition-colors`}>
