...
import { Activity, Clock, LayoutList } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto animate-in fade-in duration-500">
            ...
            <div className="mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Jahon miqyosidagi top o'yinlar va natijalar haqida to'liq ma'lumot</p>
                </div>
